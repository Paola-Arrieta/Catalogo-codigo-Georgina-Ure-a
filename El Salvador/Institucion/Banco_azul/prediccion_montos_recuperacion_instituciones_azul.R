# ---
# title: "Predicción de montos recuperación Banco Azul"
...
slv_pagos_azul_data = dbGetQuery(connection, "
...
# str(slv_pagos_azul_data)
slv_pagos_azul_data$FECHA_PAGO = as.Date(slv_pagos_azul_data$FECHA_PAGO,format="%d/%m/%Y")
# summary(slv_pagos_azul_data)
...
slv_pagos_azul = slv_pagos_azul_data %>% 
