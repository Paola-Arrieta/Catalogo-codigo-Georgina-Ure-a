...
slv_pagos_gente_data = dbGetQuery(connection, "
...
# str(slv_pagos_gente_data)
slv_pagos_gente_data$FECHA_PAGO = as.Date(slv_pagos_gente_data$FECHA_PAGO,format="%d/%m/%Y")
# summary(slv_pagos_gente_data)
...
slv_pagos_gente = slv_pagos_gente_data %>% 
