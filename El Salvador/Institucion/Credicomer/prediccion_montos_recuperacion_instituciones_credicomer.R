# ---
# title: "Predicción de montos recuperación Credicomer"
...
# # Se tienen observaciones desde 2023-01 hasta 2023 (no necesariamente equiespaciadas o consecutivas, por lo que hay que cerciorarse de que esta condición se cumpla; de no ser así se puede plantear recurrir a la imputación).
