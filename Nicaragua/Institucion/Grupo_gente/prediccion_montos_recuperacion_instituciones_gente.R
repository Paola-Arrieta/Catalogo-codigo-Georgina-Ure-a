...
nic_pagos_gente_data = dbGetQuery(connection, "
...
# str(nic_pagos_gente_data)
nic_pagos_gente_data$FECHA_PAGO = as.Date(nic_pagos_gente_data$FECHA_PAGO,format="%d/%m/%Y")
# summary(nic_pagos_gente_data)
...
nic_pagos_gente = nic_pagos_gente_data %>% 
