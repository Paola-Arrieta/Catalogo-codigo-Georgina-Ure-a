# ---
# title: "Conexión de Mongo DB con R"
# author: "Georgina Ureña Ballestero"
# output: html_document
# date: "2023-09-22"
# ---
  
# Como solución al almacenamiento de los resultados que vamos obteniendo cada vez que se corre el modelo de predicción de pago, se planteó realizarlo con Mongo DB.
# 
...
predicciones_finales = readRDS(file = "C:/Users/gurenab/Documents/Predicción de pago/src/predicciones_finales.rds")
head(predicciones_finales)

# Conexión con MongoDB collection para agregar la data nueva
c = mongo(collection = "predicciones_finales", db="Prediccion_pago")

# Agrego la data nueva
c$insert(predicciones_finales)


# Comprobaciones

# Verifico cúantos de esos valores agregados son distintos
# c$distinct("CLI_IDENTIFICACION")
