...
# summary(cr_pagos_davivienda_alquimias_data)
...
# n_alquimias = cr_pagos_davivienda_alquimias %>%
#   group_by(ALQUIMIA) %>%
#   tally() # Counts how many elements are in each group
# # Hay 3 alquimias; además, se debe determinar si las observaciones están en fechas consecutivas.
