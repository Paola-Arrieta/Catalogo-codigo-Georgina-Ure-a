# ---
# title: "Predicción de montos recuperación APAP"
...
dom_pagos_apap_data = dbGetQuery(connection, "
...
# str(dom_pagos_apap_data)
dom_pagos_apap_data$FECHA_PAGO = as.Date(dom_pagos_apap_data$FECHA_PAGO,format="%d/%m/%Y")
# summary(dom_pagos_apap_data)
...
dom_pagos_apap = dom_pagos_apap_data %>% 
