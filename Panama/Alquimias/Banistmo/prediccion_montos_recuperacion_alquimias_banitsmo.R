# ---
# title: "Predicción de montos recuperación: Alquimias de Banistmo"
...
pan_pagos_banistmo_alquimias_data = dbGetQuery(connection, "
...
# str(pan_pagos_banistmo_alquimias_data)
pan_pagos_banistmo_alquimias_data$FECHA_PAGO = as.Date(pan_pagos_banistmo_alquimias_data$FECHA_PAGO,format="%d/%m/%Y")
# summary(pan_pagos_banistmo_alquimias_data)

# Se agrupa el total de pagos por fecha, ya que el objetivo es pronosticar de forma global (en este caso) y no por cliente.
pan_pagos_banistmo_alquimias = pan_pagos_banistmo_alquimias_data %>% 
...
# n_alquimias = pan_pagos_banistmo_alquimias %>%
#   group_by(ALQUIMIA) %>%
...
alquimias_mes_anterior = pan_pagos_banistmo_alquimias %>%
  select(-INSTITUCION) %>%
...
predicciones_finales_banistmo_alquimias = bind_rows(alquimias_mes_anterior, predicciones_finales) %>%
  arrange(ALQUIMIA) %>%
...
saveRDS(predicciones_finales_banistmo_alquimias, "predicciones_finales_banistmo_alquimias.rds")
