...
gtm_pagos_ficohsa_data = dbGetQuery(connection, "
...
# str(gtm_pagos_ficohsa_data)
gtm_pagos_ficohsa_data$FECHA_PAGO = as.Date(gtm_pagos_ficohsa_data$FECHA_PAGO,format="%d/%m/%Y")
# summary(gtm_pagos_ficohsa_data)
...
gtm_pagos_ficohsa = gtm_pagos_ficohsa_data %>% 
